var prompts_and_responses = {
  ...
  'blackhole' : ['Fun Fact: A person being pulled into a relatively small black hole will find themselves pulled into spaghetti long before they reach the event horizon.', 'Black holes can accurately be considered rips in our universe. The so-called analytical extension of the space time of a simplistic black hole yields an image of two universes tangent to each other.', 'The event horizon of a black hole is a point where even light seems to stand still - to an outside observer. Ignoring tidal forces, someone falling into the black hole would notice no difference between the event horizon and regions beyond, and the rest of space.', 'Black holes aren\'t totally black: quantum fluctuations in the spacetime surrounding a black hole lead to the emission of \"Hawking Radiation\" continuously over the black hole\'s lifetime.', 'Quasars are some of the brightest objects in the universe, often as bright as thousands of galaxies. They are supermassive black holes, galactic cores, belching off high-energy radiation as they consume infalling gas and dust from their surrounding accretion disks.', 'The most distant black hole ever detected is ULAS J1342+0928. Light observed from this black hole, which weighs an estimated 800 million solar masses, is thought to have been emitted when the universe was only 690 million years old (13.01 billion years ago).', 'A black hole is a region of such intense gravity that not even light can escape.', 'Most black holes are remnants of collapsed stars after a supernova, but some black holes, sources of the most energetic light in the universe and larger than millions of stars put together, are still shrouded in mystery.', 'The first direct \"imaging\" of a black hole was accomplished in mid 2019 by capturing the shadow of the central supermassive black hole of the galaxy M87 against visible light from gas falling inward towards its event horizon.', 'Some of the most commonly-seen black hole emissions are high x-ray activity and a single emission line in the radio spectrum, evincing a binary star-black hole system where material from the star (generally a red dwarf) is constantly bled off and \"fed\" into the black hole.', 'The x-ray source Cygnus X-1, the brightest x-ray source in the Cygnus constellation, was the first object widely accepted to be a black hole.', 'Most black holes, being x-ray sources, are given names consisting of the name of the constellation they reside in, followed by a capital \"X,\" a dash, and then a number specifying what-number-brightest that object is (for example, the black hole Cygnus X-1 is the brightest x-ray source in the Cygnus constellation).', 'The movie Interstellar (2014), directed by Christopher Nolan, contains one of the most accurate depictions of what a black hole would look like in history.', 'Caltech-based physicist Kip Thorne worked with British vfx company Double Negative to render incredibly true-to-physics images of a black hole for the movie Interstellar. The images in the film depict numerical solutions to Einstein\'s field equations, and are unlike any other images of black holes that existed at the time the film released in 2014.', 'The second law of black hole dynamics states that the surface area of all the black holes in the universe can never decrease.', 'Garguntua, the black hole featured in the movie Interstellar (2014), is spinning at 99.9% of the theoretical maximum - if its rotation increased by one part in a thousand (through some physically impossible process), the event horizon of the black hole would vanish and reveal a naked singularity.', 'Garguntua, the black hole in Interstellar (2014), is totally accurate to the theory of General Relativity save one respect - the absence of Doppler shift - and totally realistic save two - the speed of its rotation and the temperature, density, and size of its accretion disk.', 'Garguntua, the black hole in Interstellar (2014), was rendered with an accretion disk of about 4,226 Celsius (~7,640 Farenheit, about 22% colder than the surface of the Sun).'], // same as 'black hole'
  ...
  'water' : ['Water is one of the only known substances for which the liquid phase is denser than the solid phase.', 'Water is one of the only known substances whose solid form floats on its liquid form.', 'Water is one of the only known substances whose solid form floats on its liquid form. If this were not the case, life likely never would have developed on Earth, because sinking ice may have killed any organisms or proto-organisms developing in the oceans when surface temperatures dropped on the daily, yearly, 11-year, or longer-term temperature variations that happen on Earth.'],
  ...
  'helium' : ['Fun Fact: helium was detected in the Sun before it was discovered on Earth.', 'In 1868, as the practice of spectroscopy was first being developed, the spectral fingerprint of an unknown element was detected in the Sun - this element was helium, and it wasn\'t found on Earth until 27 years later.', 'The name \"helium\" comes from Helios, a Greek sun god, because it was detected in the Sun before it was detected on Earth.'],
  ...
  'diamond' : ['Fun Fact: at pressures lower than about 15,000 atmospheres, diamond spontaneously turns into graphite. In the language of more familiar phase changes, diamond \"melts\" into graphene very slowly.', 'Fun Fact: at pressures lower than about 15,000 atmospheres, diamond spontaneously turns into graphite. In the language of more familiar phase changes, diamond \"melts\" into graphite very slowly near room temperature and pressure. So no, diamonds are not forever.', 'Diamonds can form naturally starting at depths of about 50 kilometers (31 miles) underground.',  'Diamonds can form naturally starting at depths of about 50 kilometers (31 miles) underground (assuming the rock to be at room temperature - this boundary gets deeper as the temperature of the surrounding rock increases).', 'Diamond, the hardest naturally-forming substance known to man, forms most readily in extremely high pressures and relatively low temperatures.', 'The Gibbs free energy of diamond is higher than that of graphite near room temperature and pressure, so diamond spontaneously phase changes into graphite. Diamonds are NOT forever.', 'The crystalline structure of diamond is a uniform tetrahedral locking of carbon atoms, each atom connecting to four others around it.', 'In a diamond, the bonds connecting carbon atoms are 109.5 degrees away from their closest neighbors, and all are the same length (approximately 1.544 angstroms).', 'In a diamond, the bonds connecting carbon atoms are 109.5 degrees away from their closest neighbors, and all are the same length (approximately 1.544 angstroms), giving diamond a density of around 3.51 grams per cubic centimeter (the densest of carbon\'s solid phases).'],
  ...
  'cno cycle' : ['In large stars, the catalytic \"CNO cycle\" of fusion releases the most energy during the main sequence. One carbon-12 nucleus goes in with four free protons, and after 4 fusings and 2 proton decays, the carbon-12 nucleus re-emerges alongside a helium-4 nucleus, two positrons, two neutrinos, and boatloads of photonic energy.', 'In the main branch of the CNO cycle, hydrogen fuses onto carbon, nitrogen, and oxygen nuclei, increasing their atomic number until they form the unstable isotopes nitogen-13 or oxygen-15, when a proton decays into neutron and a positron, decreasing the atomic number of the nucleus and making the stable nuclide needed for the next step of the process. In the end, a nitrogen-15 nucleus and a proton fuse and shatter into a helium-4 nucleus and a carbon-12 nucleus, which starts the process over.'],
  ...
  'freedom' : ['\"Degrees of freedom\" are all the independent ways the components of a system can contain energy. For example, a monatomic ideal gas has three degrees of freedom, for the three possible independent directions in which the molecules can have velocity (and therefore kinetic energy).'],

  'degrees' : ['\"Degrees of freedom\" are all the independent ways the components of a system can contain energy. For example, a monatomic ideal gas has three degrees of freedom, for the three possible independent directions in which the molecules can have velocity (and therefore kinetic energy).'],
  ...
  'allotrope' : ['The different structural forms of an element are known as \"allotropes\" - for example, carbon and graphene are two different allotropes of carbon; the former natural, the latter man-made.', 'The word \"allotrope\" only applies to elements - for compounds, the corresponding term is \"polymorphs\" or \"polymorphism.\"'],

  'phase' : ['The different structural forms of an element are known as \"allotropes\" - for example, carbon and graphene are two different allotropes of carbon; the former natural, the latter man-made.', 'In statistical mechanics, a \"phase change\" is some transition of state parameters (like pressure or temperature) during which there is a discontinuous change in the material\'s properties - for example, decreasing the temperature of pure nitrogen from -195 to -196 Celsius (-319 to -320.8 Farenheit) causes a sudden increase in density, as it changes from gas to liquid forms.', 'In wave mechanics, the term \"phase\" essentially corresponds to the argument of the sine or cosine function representing the wave - two waves that are \"in phase\" have the same wavelengths and peaks/troughs at the same locations.'], // phase angles and phases of matter (tie-in to imaginary numbers)
