var prompts_and_responses = {
    ...
    //'alpha centauri' : ['The alpha centauri star system is actually composed of three individual stars orbiting their mutual center of mass, along with an assortment of planets and smaller bodies.'],
    ...
    //'wave-particle duality' : [], // (check out appendix A of schroeder)
    ...
    //'ferromagnet' : ['The Curie temperature for iron is 1043 Kelvin (1418 Farenheit).'],
  
    //'paramagnet' : ['Under very specific circumstances, paramagnets can actually have negative temperature '],
  
    //'curie temperature' : ['The Curie temperature for iron is 1043 Kelvin (1418 Farenheit).'],
    ...
    //'impulse' : ['An \"impulse\" refers to a very large force applied over a very short time, and is approximated as an instantaneous change in velocity.'],
    ...
    //'conservative' : ['A force field is conservative when the work done on a mass moving between two points is independent of the particular path taken between those two paths.'],
